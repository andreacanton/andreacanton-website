...
- [ ] **T1.2 · Fissare la versione di Bun**
  ...
  - Dipende da: nessuno
- [ ] **T1.3 · Redirect delle vecchie URL**
  - Complessità: low
...
- [ ] **T3.1 · Semplificare il frontmatter**
  - Complessità: low
...
Da fare da soli e da rivedere a mano: le fasi successive si appoggiano a questo file.

- [ ] **T4.1 · Nucleo di `build.ts`**
  - Complessità: medium (HUMAN ONLY: revisione del nucleo da cui dipendono tutti i task successivi)
...
- [ ] **T6.1 · Confronto con lo snapshot**
  - Complessità: medium
...
- [ ] **T6.2 · Controllo visivo**
  - Complessità: low (HUMAN ONLY: giudizio visivo e di accessibilità nel browser)
...
- [ ] **T7.4 · Verifica sulla deploy preview**
  - Complessità: low (HUMAN ONLY: richiede il push e la deploy preview di Netlify)
...
- Task totali: 18
- Fatti: 0
- Da fare: 18 (di cui HUMAN ONLY: 3)
- Fase corrente: 1 · Preparazione
