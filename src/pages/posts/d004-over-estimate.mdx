...
When I'm not feeling confident, I multiply by 2 or even 3 my estimates.

As a developer, even as a junior developer, you are responsible for the quality of the code, but our job is full of pitfalls. We have to check performance, maintainability, security and many other subjects. They require time.
...
So when you give yourself the chance to have some extra-time, you can really improve your codebase, and deliver very high quality code. Thirty minutes extra can be enough to make improvements.
